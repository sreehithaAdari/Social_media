...
const Register = () => {
  ...
  return (
    <div className="bg-bgColor w-full h-[100vh] flex items-center justify-center p-15">
      <div
...
<Link to="/" className="flex gap-2 items-center">
        ...
        <span className="text-2xl text-[#065ad8]" font-semibold="true">
          ...
          >
            <div className="w-full flex flex-col lg:flex-row gap-1 first-letter:md:gap2">
              <TextInput
                label="First Name"
                ...
                register={register("firstName", {
                  required: "first name donot match",
                })}
              ...
              <TextInput
                ...
                register={register("lastName", {
                  required: "last name donot match",
                })}
